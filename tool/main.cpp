...

{
    ...
    ifstream fichier("../example_exe", ios::in);
    ifstream fichierH("../example", ios::in);
    ...
    transformationASM(instruction,proba,link,var,fonction,hamming,select,res,box,false,false);
